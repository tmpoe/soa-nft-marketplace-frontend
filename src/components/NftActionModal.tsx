...
export default function NftActionModal({ nftActionData }: { nftActionData: NftActionData }) {
    ...
    async function listNft(tokenId: string) {
        ...
        try {
            ...
            nftMarketplace.listNft(tokenId, nft.getAddress(), price, address!)
        } catch (error) {
            console.error(error)
            setApproving(false)
        }
            ...
            <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                <div className="relative w-auto my-6 mx-auto max-w-3xl">
                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                        ...
                        {!nftActionData.isListed && !approving && getListingBody()}
                        {approving && (
                            <div className="m-10 p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <p>
                                    Approving your NFT for the market to handle can take a few
                                    seconds. Please wait.
                                </p>
                            </div>
                        )}
